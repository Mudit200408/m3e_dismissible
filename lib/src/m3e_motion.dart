...
/// Spring animation configuration for Material 3 Expressive dismissible cards.
///
/// Use with [M3EDismissibleCardStyle.snapBackMotion] / [M3EDismissibleCardStyle.flyMotion]
/// to customize the spring physics for drag and dismiss animations.
///
/// ## Motion Presets
///
/// The class provides two families of presets:
/// - **Spatial** motions: animate the card's shape (border radius) during drag
/// - **Effects** motions: animate opacity/scale effects during fly-out
///
...
///   snapBackMotion: M3EMotion.custom(stiffness: 800, damping: 0.5),
///   flyMotion: M3EMotion.custom(stiffness: 1000, damping: 0.8),
/// )
/// ```
///
/// See also:
/// - [M3EDismissibleCardList] for list-based dismissible cards
/// - [M3EDismissibleCardColumn] for column-based dismissible cards
/// - [SliverM3EDismissibleCardList] for sliver-based dismissible cards
@immutable
class M3EMotion {
  const M3EMotion._({
  ...
  const factory M3EMotion.custom({
